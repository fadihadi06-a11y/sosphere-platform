...
-- 5 migrations combined. Each DDL statement auto-commits.
-- Safe to run multiple times (IF NOT EXISTS / OR REPLACE / DROP+CREATE).
-- ═══════════════════════════════════════════════════════════════════════
-- Copy-paste ENTIRE file into Supabase Dashboard → SQL Editor → Run.
...
-- ═══════════════════════════════════════════════════════════════════════
-- DONE. Run the verification query in a separate tab to confirm.
-- ═══════════════════════════════════════════════════════════════════════
